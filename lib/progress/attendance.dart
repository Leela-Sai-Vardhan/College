        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _buildDateBox('Oct 01, 2025'),
                Text('-'),
                _buildDateBox('Oct 31, 2025'),
              ],
            ),
            const SizedBox(height: 16),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  _buildTaskRow('Classes', Colors.green, 1.0),
                  _buildTaskRow('Lab', Colors.orange, 0.54),
                  _buildTaskRow('OpenElective', Colors.red, 0.37),
                  _buildTaskRow('Epics', Colors.orange, 0.5),
                ],
              ),
            ),
          ],
